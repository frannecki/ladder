...
MemoryPoolImpl* MemoryPoolImpl::instance() { return MemoryPoolImpl::create(); }

MemoryPoolImpl* MemoryPoolImpl::create(size_t num_blocks, size_t block_size) {
  static MemoryPoolImpl* instance = new MemoryPoolImpl(num_blocks, block_size);
...
MemoryPoolImpl::MemoryPoolImpl(size_t num_blocks, size_t block_size)
